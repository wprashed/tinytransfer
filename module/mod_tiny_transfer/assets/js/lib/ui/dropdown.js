...
(function(factory) {
        ...
        function construct(data) {
            ...
            data.useNative = data.native || UI.isMobile;
            ...
            if ($.fn.fsScrollbar !== undefined) {
                data.$wrapper.fsScrollbar({
                    theme: data.theme
                }).find(".ui-scrollbar-content").attr("tabindex", null);
            }
        ...
        function onKeypress(e) {
            ...
            if (e.keyCode === 13) {
                ...
                if ($.inArray(e.keyCode, (UI.isFirefox) ? [38, 40, 37, 39] : [38, 40]) > -1) {
                    // Increment / decrement using the arrow keys
                    index = index + ((e.keyCode === 38 || (UI.isFirefox && e.keyCode === 37)) ? -1 : 1);
        ...
        function scrollOptions(data) {
            ...
            if ($.fn.fsScrollbar !== undefined) {
                data.$wrapper.fsScrollbar("resize")
                    .fsScrollbar("scroll", (data.$wrapper.find(".ui-scrollbar-content").scrollTop() + selectedOffset.top));
            } else {
